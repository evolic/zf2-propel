...
use PropelORM\Model\map\PersonTableMap;
...
abstract class BasePersonPeer
{
    ...
    const OM_CLASS = 'PropelORM\\Model\\Person';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PersonPeer::ID, PersonPeer::NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PersonPeer::ID => 0, PersonPeer::NAME => 1, ),
    ...
    {
        // Invalidate objects in FriendPeer instance pool,
