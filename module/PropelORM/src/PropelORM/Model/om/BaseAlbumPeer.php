...
use PropelORM\Model\map\AlbumTableMap;
...
abstract class BaseAlbumPeer
{
    ...
    const OM_CLASS = 'PropelORM\\Model\\Album';
    ...
    /** the column name for the discs field */
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Artist', 'Title', 'Discs', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'artist', 'title', 'discs', ),
        BasePeer::TYPE_COLNAME => array (AlbumPeer::ID, AlbumPeer::ARTIST, AlbumPeer::TITLE, AlbumPeer::DISCS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ARTIST', 'TITLE', 'DISCS', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'artist', 'title', 'discs', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Artist' => 1, 'Title' => 2, 'Discs' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'artist' => 1, 'title' => 2, 'discs' => 3, ),
        BasePeer::TYPE_COLNAME => array (AlbumPeer::ID => 0, AlbumPeer::ARTIST => 1, AlbumPeer::TITLE => 2, AlbumPeer::DISCS => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ARTIST' => 1, 'TITLE' => 2, 'DISCS' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'artist' => 1, 'title' => 2, 'discs' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AlbumPeer::ARTIST);
            $criteria->addSelectColumn(AlbumPeer::TITLE);
            $criteria->addSelectColumn(AlbumPeer::DISCS);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.artist');
            $criteria->addSelectColumn($alias . '.title');
            $criteria->addSelectColumn($alias . '.discs');
        }
    }
